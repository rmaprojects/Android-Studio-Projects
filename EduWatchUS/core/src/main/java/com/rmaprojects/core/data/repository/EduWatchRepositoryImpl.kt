...
class EduWatchRepositoryImpl @Inject constructor(
    ...
    override suspend fun getStudents(schoolId: Int): List<StudentsEntity> {
        return remoteDataSource.getStudents(schoolId)
    }
    ...
    override suspend fun getAllSchool(): List<SchoolEntity> {
        return remoteDataSource.getAllSchool()
    }

    override suspend fun registerSchool(schoolName: String): List<SchoolEntity> {
        return remoteDataSource.registerSchool(schoolName)
    }
}